...
// 4.根据执行结果给出响应
    if($result==true){ //函数返回值
        ...
        // echo '<a href="../html/login.html" style="font-size:40px;color:blue;">立即登录</a>';
        echo '<script language="javascript">';
        echo 'window.location.href="../html/login.html";';  //注册成功后直接跳转到登录页面
        echo '</script>';
    }else{
        echo '<script language="javascript">';
        echo 'window.location.href="../html/reg.html";';  //注册失败后依然跳转到注册页面
        echo '</script>';
    };
?>